...
# Default-Stop:		0 1 6
# Short-Description:	cortex-monitor - Cortex deployment environment
# Description:		cortex-monitor - Cortex deployment environment
### END INIT INFO
...
APP_NAME="CortexMonitor"
APP_FILENAME="cortex-monitor"
